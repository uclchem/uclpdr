...
SUBROUTINE FIND_EVALUATION_POINTS(NPART,NRAYS,PARTICLE)
   ...
   REAL(KIND=DP), PARAMETER :: NR = -1.0D0/SQRT(3.0D0)
...
!  Define the unit vector direction of each ray in Cartesian coordinates
   ...
   DATA RAY_VECTOR(6,:) /NR,NR,NR/
   DATA RAY_VECTOR(7,:) /NR,R,NR/
   DATA RAY_VECTOR(8,:) /R,R,NR/
   DATA RAY_VECTOR(9,:) /R,NR,NR/
   DATA RAY_VECTOR(10,:)/NR,NR,R/
   DATA RAY_VECTOR(11,:)/NR,R,R/
   DATA RAY_VECTOR(12,:)/R,R,R/
   DATA RAY_VECTOR(13,:)/R,NR,R/
